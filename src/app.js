  ...
  const chart = c3.generate({
    ...
    agenttip: {
      contents: function (d, defaultTitleFormat, defaultValueFormat, color) {
        let $$ = this,
          config = $$.config,
          titleFormat = config.agenttip_format_title || defaultTitleFormat,
          nameFormat =
            config.agenttip_format_name ||
            function (name) {
              return name;
            },
          valueFormat = config.agenttip_format_value || defaultValueFormat,
          text,
          i,
          title,
          value,
        ...
        for (i = 0; i < d.length; i++) {
          ...
          text += "<tr class='" + $$.CLASS.agenttipName + "-" + d[i].id + "'>";
          text +=
        ...
        text += "<tr class='" + $$.CLASS.agenttipName + "'>";
